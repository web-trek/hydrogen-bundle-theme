  ...
  return (
    <>
          ...
          >
            ...
            >
              ...
              <div class="product-item__ratings !mb-6" bis_skin_checked="1">
                <div class="product-item__ratings !mt-2 !ml-0 !flex !align-middle gap-1" bis_skin_checked="1"><svg class=" !self-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg><svg class=" !self-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg><svg class=" !self-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg><svg class=" !self-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg><svg class=" !self-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg><span class="ml-4"> (06)</span></div>
              </div>
              ...
              >
                ...
                >
                  ...
                  {/* <script type="application/json">
                                        [{"id":44498401526078,"title":"Clear","option1":"Clear","option2":null,"option3":null,"sku":null,"requires_shipping":true,"taxable":true,"featured_image":{"id":40376516182334,"product_id":8119735157054,"position":1,"created_at":"2023-02-06T05:14:17-05:00","updated_at":"2023-02-06T05:14:32-05:00","alt":null,"width":3500,"height":3500,"src":"\/\/bundle-theme-demo-home.myshopify.com\/cdn\/shop\/products\/15-2.jpg?v=1675678472","variant_ids":[44498401526078]},"available":true,"name":"Carafe 1.2Ltr. - Clear","public_title":"Clear","options":["Clear"],"price":5500,"weight":0,"compare_at_price":null,"inventory_management":null,"barcode":null,"featured_media":{"alt":null,"id":32713204859198,"position":1,"preview_image":{"aspect_ratio":1.0,"height":3500,"width":3500,"src":"\/\/bundle-theme-demo-home.myshopify.com\/cdn\/shop\/products\/15-2.jpg?v=1675678472"}},"requires_selling_plan":false,"selling_plan_allocations":[]},{"id":44498401558846,"title":"Amber","option1":"Amber","option2":null,"option3":null,"sku":null,"requires_shipping":true,"taxable":true,"featured_image":{"id":40376516215102,"product_id":8119735157054,"position":2,"created_at":"2023-02-06T05:14:17-05:00","updated_at":"2023-02-06T05:14:32-05:00","alt":null,"width":3500,"height":3500,"src":"\/\/bundle-theme-demo-home.myshopify.com\/cdn\/shop\/products\/15-3.jpg?v=1675678472","variant_ids":[44498401558846]},"available":true,"name":"Carafe 1.2Ltr. - Amber","public_title":"Amber","options":["Amber"],"price":5500,"weight":0,"compare_at_price":null,"inventory_management":null,"barcode":null,"featured_media":{"alt":null,"id":32713204793662,"position":2,"preview_image":{"aspect_ratio":1.0,"height":3500,"width":3500,"src":"\/\/bundle-theme-demo-home.myshopify.com\/cdn\/shop\/products\/15-3.jpg?v=1675678472"}},"requires_selling_plan":false,"selling_plan_allocations":[]},{"id":44498401591614,"title":"Moss","option1":"Moss","option2":null,"option3":null,"sku":null,"requires_shipping":true,"taxable":true,"featured_image":{"id":40376516247870,"product_id":8119735157054,"position":4,"created_at":"2023-02-06T05:14:17-05:00","updated_at":"2023-02-06T05:14:32-05:00","alt":null,"width":3500,"height":3500,"src":"\/\/bundle-theme-demo-home.myshopify.com\/cdn\/shop\/products\/15-5.jpg?v=1675678472","variant_ids":[44498401591614]},"available":true,"name":"Carafe 1.2Ltr. - Moss","public_title":"Moss","options":["Moss"],"price":5500,"weight":0,"compare_at_price":null,"inventory_management":null,"barcode":null,"featured_media":{"alt":null,"id":32713204760894,"position":4,"preview_image":{"aspect_ratio":1.0,"height":3500,"width":3500,"src":"\/\/bundle-theme-demo-home.myshopify.com\/cdn\/shop\/products\/15-5.jpg?v=1675678472"}},"requires_selling_plan":false,"selling_plan_allocations":[]}]
                                    </script> */}
                </product-variants>
                <div
                  ...
                  bis_skin_checked="1"
                >
                  {/* <form method="post" action="/cart/add" id="product-form-add-quick-buy-template--17238267691326__627a9841-5ef4-4a4b-8ba7-aacbfbb91f3f-1" accept-charset="UTF-8" class="form" enctype="multipart/form-data" novalidate="novalidate" data-type="add-to-cart-form"/>
                                        <input type="hidden" name="form_type" value="product"><input type="hidden" name="utf8" value="✓" />
                                        <template>
                                        <input type="hidden" name="id" value="44498401526078"/>
                                        </template>
                                        <script>
                                        document.getElementById('add-to-cart-add-quick-buy-template--17238267691326__627a9841-5ef4-4a4b-8ba7-aacbfbb91f3f-1').querySelector('form').append(document.getElementById('add-to-cart-add-quick-buy-template--17238267691326__627a9841-5ef4-4a4b-8ba7-aacbfbb91f3f-1').querySelector('template').content.cloneNode(true));
                                        </script>
                                        <input type="hidden" name="id" value="44498401526078"/>
                                        <button type="submit" name="add" class="add-to-cart 
                                        disabled " data-js-product-add-to-cart="" title="Choose a variant first">
                                        <span class="button__text" data-js-product-add-to-cart-text="">Choose a variant first</span>
                                        <span class="button__preloader">
                                            <svg class="button__preloader-element" viewBox="25 25 50 50">
                                                <circle cx="50" cy="50" r="20" fill="none" stroke-width="4" style="fill:none!important"></circle>
                                            </svg>
                                        </span>
                                        <svg width="39" height="29" viewBox="0 0 39 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M34.5104 1.79071L37.4476 4.72792L14.929 27.2466L11.9918 24.3093L34.5104 1.79071Z" fill="none"></path>
                                            <path d="M17.8662 24.3093L14.929 27.2466L2.20109 14.5186L5.1383 11.5814L17.8662 24.3093Z" fill="none"></path>
                                            <path d="M34.864 1.43716L34.5104 1.0836L34.1569 1.43716L14.929 20.665L5.49186 11.2279L5.1383 10.8743L4.78475 11.2279L1.84754 14.1651L1.49398 14.5186L1.84754 14.8722L11.2847 24.3093L11.6382 24.6629L14.5755 27.6001L14.929 27.9537L15.2826 27.6001L18.2198 24.6629L18.5733 24.3093L37.8012 5.08148L38.1548 4.72792L37.8012 4.37437L34.864 1.43716Z" stroke="var(--color-text-main)" stroke-opacity="1" fill:none=""></path>
                                        </svg>
                                        </button>
                                        <input type="hidden" name="product-id" value="8119735157054"><input type="hidden" name="section-id" value="template--17238267691326__627a9841-5ef4-4a4b-8ba7-aacbfbb91f3f"/>
                                    </form> */}
                </div>
      ...
      <span class="set-action__button">
        ...
        <div class="set-action__button-text element--hide-on-desk" bis_skin_checked="1"><span class="set-action__button-text__title text-weight--bold">
              Build your set
            </span></div>
